...
m1.ca <- lmer(sqrt(native.cover) ~ trt * water + (1 | Year) + (1 | structure), data = allca)
summary(m1.ca) 
anova(m1.ca)
...
m2lma.ca <- lmer(sqrt(native.cover) ~ water * LMA + (1 | Year)+ (1 | structure), data = allca)
summary(m2lma.ca) 
anova(m2lma.ca)
anova(m1.ca,m2lma.ca) #NOT better than seeding trt
m2sm.ca <- lmer(sqrt(native.cover) ~ water * seed.mass + (1 | Year)+ (1 | structure), data = allca)
summary(m2sm.ca) 
anova(m2sm.ca)
anova(m1.ca,m2sm.ca) #NOT better than seeding trt
anova(m2lma.ca,m2sm.ca) #Better than lma (?)
m2rd.ca <- lmer(sqrt(native.cover) ~ trt * Rdiam + (1 | Year)+ (1 | structure), data = allca)
summary(m2rd.ca) 
anova(m2rd.ca)
...
m3.ca <- lmer(sqrt(native.cover) ~ trt * dist * water + (1 | Year)+ (1 | structure), data = allca)
summary(m3.ca)
anova(m3.ca)
